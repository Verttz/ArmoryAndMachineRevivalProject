...
export const RESOURCE_DEFINITIONS: ResourceDefinition[] = [
  ...
  },
  {
    id: 'energy_cell',
    name: 'Energy Cell',
    description: 'Portable energy source for powering advanced machinery.',
    initialAmount: 0,
    cap: 300,
    baseRate: 0,
  ...
  },
  {
    id: 'component_kit',
    name: 'Component Kit',
    description: 'Pre-assembled technical components for construction.',
    initialAmount: 0,
    cap: 150,
    baseRate: 0,
  ...
  },
  {
    id: 'advanced_alloy',
    name: 'Advanced Alloy',
    description: 'Cutting-edge material combining multiple metals.',
    initialAmount: 0,
    cap: 100,
    baseRate: 0,
